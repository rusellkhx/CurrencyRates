...
class CurrencyService: CurrencyServiceProtocol {
    ...
    init() {
        ...
        inputCurrency = storageService.savedInputCurrency() ?? Currency.defaultFirstCurrency()
        outputCurrency = storageService.savedOutputCurrency() ?? Currency.defaultSecondCurrency()
    }
